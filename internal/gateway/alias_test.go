...
func TestResolveModel(t *testing.T) {
	tests := []struct {
		...
		{name: "deepseek flash vision", request: "deepseek-flash", provider: config.ProviderDeepSeek, model: config.ModelDeepSeekFlash, policy: PolicyDeepSeek},
		...
		{name: "deprecated deepseek flash alias o3-mini", request: DeprecatedAliasDeepSeekFlash, provider: config.ProviderDeepSeek, model: config.ModelDeepSeekFlash, policy: PolicyDeepSeek},
		...
		{name: "openrouter flash upstream", request: "deepseek/deepseek-v4.1-flash", provider: config.ProviderOpenRouter, model: "deepseek/deepseek-v4.1-flash", policy: PolicyDeepSeek},
