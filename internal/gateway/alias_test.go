...
func TestResolveModel(t *testing.T) {
	tests := []struct {
		...
		{name: "deepseek flash alias", request: "o3-mini", provider: config.ProviderDeepSeek, model: config.ModelDeepSeekV4FlashVisionExp, policy: PolicyDeepSeek},
		...
		{name: "real deepseek flash vision", request: "deepseek-v4-flash-vision-exp", provider: config.ProviderDeepSeek, model: config.ModelDeepSeekV4FlashVisionExp, policy: PolicyDeepSeek},
		...
		{name: "zai gpt-4.1 alias", request: "gpt-4.1", provider: config.ProviderZai, model: config.ModelZaiGLM53Flash, policy: PolicyZai},
		{name: "real glm-5.3", request: "glm-5.3", provider: config.ProviderZai, model: "glm-5.3", policy: PolicyZai},
		{name: "real glm-5.3-flash", request: "glm-5.3-flash", provider: config.ProviderZai, model: config.ModelZaiGLM53Flash, policy: PolicyZai},
