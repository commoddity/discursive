...
func TestSetModelFlag(t *testing.T) {
	...
	if loaded.AliasModel != "o3-mini" || loaded.RealModel != "deepseek-flash" {
		t.Fatalf("got alias=%q real=%q want o3-mini deepseek-flash", loaded.AliasModel, loaded.RealModel)
	}
}
